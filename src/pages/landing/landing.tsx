...
export function LandingPage() {
  ...
  return (
    <>
      <title>Loop — Your AI Student Learning Assistant</title>
      <meta
        name="description"
        content="Loop connects Canvas, Google Calendar, and Notion into one AI assistant that helps you stay on top of your courses."
      />
        ...
        >
          <div className="max-w-7xl mx-auto px-6">
            ...
            >
              ...
              <p className="mt-3 text-gray-500 text-lg">
                Loop understands your academic context. Here's a taste of what
                you can do.
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="mt-4 text-gray-500 leading-relaxed">
                ...
                . It was built to solve a real problem: juggling multiple
                courses, deadlines, and tools without a single place to stay
                organized.
              </p>
                ...
                <div className="space-y-4">
                  <div className="bg-gray-50 rounded-xl p-4">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {["AI/ML", "Education", "Full-Stack", "APIs"].map(
                        (tag) => (
                          <span
                            key={tag}
